...
{	
    ...
    //------------------------------------------//
    bool if_safety_search_;
    double dist_safety_;
    double getObsCost(const Eigen::Vector3d& cur_pt);
    double getViewCost(const Eigen::Vector3d& cur_pt, const Eigen::Vector3d& next_pt);
    EDTEnvironment::Ptr edt_map_;
    void setEnvironment1(const EDTEnvironment::Ptr& env);
    double getObsAndViewCost(const Eigen::Vector3d& cur_pt, const Eigen::Vector3d& next_pt);
    //------------------------------------------//
